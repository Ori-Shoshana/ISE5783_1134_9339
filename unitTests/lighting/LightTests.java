...
public class LightTests {
    ...
    /**
     * Produce a picture of a sphere lighted by a narrow spot light #BONUS#
     */
    @Test
    ...
    /**
     * Produce a picture of a two triangles lighted by a narrow spot light #BONUS#
     */
    @Test
    public void trianglesSpotSharp() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(trianglesLightColor, trianglesLightPosition, trianglesLightDirection).setNarrowBeam(10).setKl(0.001).setKq(0.00004));
    ...
    public void sphereThreeLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new DirectionalLight(new Color(RED),
                new Vector(2, 1, -0.5)));

        scene1.lights.add(new PointLight(new Color(WHITE),
                new Point(10, 10, 30)));

        scene1.lights.add(new SpotLight(new Color(ORANGE),
                new Point(100, -100, 50),
                new Vector(-100, -5, -100)));
    ...
    public void trianglesThreeLight() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new DirectionalLight(new Color (GREEN),
                new Vector(-2, 0, -0.5)));

       scene2.lights.add(new PointLight(new Color(BLUE),
                new Point(4, -10, -10)));

        scene2.lights.add(new SpotLight(new Color(WHITE),
                new Point(-4, 50, 0),
                new Vector(1, 1, -0.5)));
